...
public static class AxMath
{
    ...
    public static float TrueDistance(Vec2I a, Vec2I b) { return TrueDistance(a.x, a.y, b.x, b.y); }
    public static float TrueDistance(int x0, int y0, int x1, int y1)
    {
    ...
    public static void ForceClockwiseOrder(List<Vector2> vertices)
    {
        ...
        for (int i = 0; i < vertices.Count - 1; i++) area += (vertices[i + 1].x - vertices[i].x) * (vertices[i + 1].y + vertices[i].y) / 2;
    ...
    public static List<Triangle> EarClip(List<Vector2> vertices)
    {
        ...
        //as long as it has more than one triangle
    ...
    public static int FindCircleCircleIntersections(float cx0, float cy0, float radius0, float cx1, float cy1, float radius1, out Vector2 intersection1, out Vector2 intersection2)
    {
        ...
        else
        {
            ...
            //distance between centers is equal to the combined radius, the circles just barely touch each other
            if (dist == radius0 + radius1)
                return 1;
