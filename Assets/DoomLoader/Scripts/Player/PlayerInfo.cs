...
public class PlayerInfo : MonoBehaviour
{
    ...
    public void Reset()
    {
        ...
        PlayerControls.Instance.CurrentWeapon = WeaponType.None;
        PlayerControls.Instance.SwapWeapon = WeaponType.None;
    ...
    void OnGUI()
    {
        ...
        {
            //made a change here, it seems this new method keeps the image on the screen longer than I would like
            var rect = new Rect(0, 0, Screen.width, Screen.height);
            GUI.DrawTexture(rect, pickupTexture, ScaleMode.StretchToFill, true, 0);
        ...
        if (painFlashTime > 0f)
        {
            //made a change here, it seems this new method keeps the image on the screen longer than I would like
            var rect = new Rect(0, 0, Screen.width, Screen.height);
            GUI.DrawTexture(rect, painTexture, ScaleMode.StretchToFill, true, 0);
